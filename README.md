...
This web app: **A React-based application to create, view, edit, and delete custom Among Us crewmates, storing data in Supabase and providing a gallery and detail pages for each crewmate.**
...
-- Creating a new table in Supabase
-- Creating a new database in Supabase
